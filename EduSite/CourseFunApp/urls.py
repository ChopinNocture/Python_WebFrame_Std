...
urlpatterns = [
    ...
    path('questions/remooove/<slug:qtype>/list/', views.delete_question_list, name='question-delete-list'),
    ...
    path('exam_answer/<int:examans_id>/<int:stud_id>/', views.exam_answer, name='exam_answer_teacher'),
