	...
	function Schedule(opt) {
		...
		var init = function () {
			var scheduleHd = '<div class="schedule-hd">' +
				'<div>' +
				'<span type="button" class="btn btn-light" id="prevYear" >&laquo;</span>' +
				'<span type="button" class="btn btn-light" id="prevMonth">&lt;</span>' +
				'</div>' +
				'<div class="today">' + formatDate(year, month + 1, day, '-') + '</div>' +
				'<div>' +
				'<span type="button" class="btn btn-light" id="nextMonth">&gt;</span>' +
				'<span type="button" class="btn btn-light" id="nextYear">&raquo;</span>' +
				'</div>' +
				'</div>'
